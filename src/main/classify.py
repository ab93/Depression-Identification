...
def get_multi_data(category='PN'):
    X_A_train, y_A_train, X_A_val, y_A_val = get_single_mode_data('acoustic', category)
    X_V_train, y_V_train, X_V_val, y_V_val = get_single_mode_data('visual', category)
    X_L_train, y_L_train, X_L_val, y_L_val = get_single_mode_data('linguistic', 'PN')
